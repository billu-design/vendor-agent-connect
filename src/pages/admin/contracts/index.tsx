          ...
          <CardContent>
            <div className="flex justify-between items-center mb-6">
              <div className="relative w-72">
                <Input placeholder="Search..." value={searchTerm} onChange={e => setSearchTerm(e.target.value)} className="pl-3" />
              </div>
              ...
              <Sheet>
                ...
                <SheetContent className="overflow-y-auto">
                  ...
                  <div className="space-y-6 py-6">
                    ...
                    <div className="space-y-2">
                      <Label>Agent</Label>
                      <Select value={filterOptions.agentId} onValueChange={value => setFilterOptions({
                      ...filterOptions,
                      agentId: value
                    })}>
                        <SelectTrigger>
                    ...
                    <div className="space-y-2">
                      <Label>Vendor</Label>
                      <Select value={filterOptions.vendorId} onValueChange={value => setFilterOptions({
                      ...filterOptions,
                      vendorId: value
                    })}>
                        <SelectTrigger>
                    ...
                    <div className="space-y-2">
                      ...
                      <Slider value={[filterOptions.minValue, filterOptions.maxValue]} min={0} max={100000} step={1000} onValueChange={value => setFilterOptions({
                      ...filterOptions,
                      minValue: value[0],
                      maxValue: value[1]
                    })} className="py-4" />
                    ...
                    <div className="space-y-2">
                      ...
                      <Select value={filterOptions.dateRange} onValueChange={value => setFilterOptions({
                      ...filterOptions,
                      dateRange: value
                    })}>
                        <SelectTrigger>
